<script
  src="../../../study/Vue全家桶+SSR+Koa2全栈开发美团网[完整版]/源码/mt-stack-master2/mt-stack/app/server/interface/search.js"></script>
<template>
...
<script>
  ...
  export default {
    ...
    async asyncData(ctx) {
      ...
      let {status: status, data: {count, pois}} = await ctx.$axios.get('/search/resultsByKeywords', {
        params: {
          keyword,
          city
        }
